...
const DIAGNOSTIC=[['Laboratory',1919],['Drug testing',294],['Imaging / radiology',278],['Cardiology',267],['Audiology / hearing',127]] as const;
  ...
  return <main className={styles.root}>
    ...
    <aside className={styles.explorerRail}>
      ...
      <div className={styles.panelBody}>
        ...
        {panel==='coverage'&&<><div className={styles.panelIntro}><span>NETWORK COVERAGE</span><h1>Where the density lives.</h1><p>The coverage panel now reports the same valid mapped coordinate field shown on the globe; records without usable coordinates are excluded.</p></div><MiniBars rows={COVERAGE} total={23524}/></>}
