...
const STORY: readonly StoryScene[] = [
  ...
  {chapter:'08 / THE WORK',title:'Different work creates different demands.',body:'From public safety to construction, energy, education, government, and deployment, the job remains central to the medical question.',images:['Diverse Workforce.png','Diverse Workforce2.png'],mode:'workforce',signal:'∞',signalLabel:'different job demands',annotation:'The job—not a generic physical—is the reference point.'},
  {chapter:'09 / DEPLOYMENT',title:'Readiness has no single border.',body:'Deployment standards, medical clearances, immunization schedules, and destination requirements are coordinated as one connected readiness process.',images:['International Certification.png','Vaccine Schedule.png'],mode:'deployment',signal:'GLOBAL',signalLabel:'destination readiness',annotation:'Standards travel with the assignment.'},
  {chapter:'10 / THE NETWORK',title:'One operating model. Thousands of locations.',body:'A worldwide medical and dental network gives every referral a place to land—stateside or abroad.',images:['Facilities.png','International Network.png'],mode:'network',signal:'23,524',signalLabel:'valid mapped coordinates',annotation:'A referral can enter the same operating model from thousands of points.'},
  {chapter:'11 / VALUES',title:'The standard is how we work.',body:'Humility. Positivity. Customer service. Quality. Integrity. Diligence.',images:['Corevalue.png','Corevalue2.png','Corevalue3.png','Corevalue4.png','Corevalue5.png','Corevalue6.png'],mode:'values',signal:'06',signalLabel:'core values',annotation:'The operating model ends where the culture begins.'},
];
