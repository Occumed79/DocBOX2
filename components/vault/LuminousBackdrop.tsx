    ...
    <svg className="wave-svg" viewBox="0 0 1600 900" preserveAspectRatio="none">
      <defs>
        <linearGradient id={`ribbon-${id}`} x1="0" x2="1" y1="0" y2="0">
          <stop offset="0" stopColor="#0B1F1A" stopOpacity="0" />
          <stop offset="0.22" stopColor="#2F7D5A" stopOpacity="0.48" />
          <stop offset="0.52" stopColor="#7FC8A9" stopOpacity="0.82" />
          <stop offset="0.78" stopColor="#124B3A" stopOpacity="0.6" />
          <stop offset="1" stopColor="#0B1F1A" stopOpacity="0" />
        </linearGradient>
        <linearGradient id={`thread-${id}`} x1="0" x2="1" y1="0" y2="0">
          <stop offset="0" stopColor="#E6F3EA" stopOpacity="0" />
          <stop offset="0.34" stopColor="#E6F3EA" stopOpacity="0.96" />
          <stop offset="0.62" stopColor="#7FC8A9" stopOpacity="0.92" />
          <stop offset="1" stopColor="#2F7D5A" stopOpacity="0" />
        </linearGradient>
